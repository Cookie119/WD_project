<footer class="footer">
    <video class="footer_video"  autoplay src="//cdn.shopify.com/s/files/1/0526/6905/5172/t/5/assets/footer.mp4?v=29581141968431347981633714450" type="video/mp4">
    </video>
          ...
          <div class="layout">
            <div class="layout_item w-50">
              <div class="newsletter">
                <h3 class="newsletter_title">Subscribe for updates on drug history discoveries and cultural shifts.</h3>
                <form action="">
            ...
            <div class="layout_item w-25">
              <nav class="c-nav-tool">
                <h4 class="c-nav-tool_title">Explore</h4>
                <ul class="c-nav-tool_list">
                  <li>
                    <a href="/collections/all" class="c-link">Origin Map</a>
                  </li>
  
                  <li>
                    <a href="/pages/about-us" class="c-link">Drug Timeline</a>
                  </li>
  
                  <li>
                    <a href="/blogs/community" class="c-link">Cultural Influence</a>
                  </li>
                  <li>
            ...
            <div class="layout_item w-25">
              <nav class="c-nav-tool">
                <h4 class="c-nav-tool_title">Resources</h4>
                <ul class="c-nav-tool_list">
  
                  <li class="c-nav-tool_item">
                    <a href="/pages/shipping-returns" class="c-link">Data Sources</a>
                  </li>
                  ...
                  <li class="c-nav-tool_item">
                    <a href="/pages/terms-conditions" class="c-link">Legal &amp; Ethical Use</a>
                  </li>
